...
放到`public/assets` 下
从素材文件index.html中将样式与body的内容抽离出来，并将其路劲由`./assets` => `/assets/home`
...
在Home模块下的`index/index.html`文件底部引入 公共底部以及轮播图脚本
